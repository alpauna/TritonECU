...
| **The truck's own reluctor: key-to-gap** ⭐⭐ | **The headline measurement now.** A review of 917-060 says its teeth do not match OEM — codes and rough running. We measured this one at **5.00°, exactly half a pitch** from the 0° the README believed OEM used. If the OEM wheel reads ~0, that review is explained and we found the defect blind | Same reading, on the truck's own wheel |
