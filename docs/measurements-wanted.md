...
| **The casting number on the OEM wheel** ⭐ | **Read this before reading the teeth.** If it is `XW1Z-12A227`, the Dorman is the *correct* part and a stagger is a manufacturing defect. If it is a different base number, the Dorman is the *wrong* part and a stagger is expected — same observation, opposite conclusions | It is cast around the hub face; the wheel is in hand |
| ~~**Does a 1999 5.4L even use this reluctor?**~~ | ◐ **Mostly dissolved.** The OE number `XW1Z-…` carries Ford's **1999** prefix (`X` = 1999, as `1` = 2001 on the donor PCM), revised to `-AC` and still cataloged for 2001-2010 — one design spanning 1999→2010 | The 2001 start is a cataloging artifact. The casting above confirms it outright |
