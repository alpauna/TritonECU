...
| **Genuine `XW1Z-12A227-AC` vs the Dorman** ⭐⭐ ⏳ **arriving 2026-09-22** | **Is 917-060 a faithful copy — is the review real?** And therefore whether the rig wheel's **5.00°** is an OE design value or somebody's defect. Pure bench test, no truck, no cover | Bar through both keyways, stack, look at the rim. **Read the casting, caliper the OD and count the teeth first** |
