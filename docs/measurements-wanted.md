...
| **Does a 1999 5.4L even use this reluctor?** | Dorman's applications all start at **2001**. 2001 is exactly where a crank-trigger revision would land | **[CONFIRM]** — parts catalogue or the truck itself |
